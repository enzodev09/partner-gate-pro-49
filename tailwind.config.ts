  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'neon-lg': '0 0 30px hsl(var(--neon-blue) / 0.6), 0 0 60px hsl(var(--neon-blue) / 0.4), 0 0 90px hsl(var(--neon-blue) / 0.2)',
      },
      animation: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          ...
          "100%": {
            boxShadow: "0 0 30px hsl(var(--neon-blue) / 0.6), 0 0 40px hsl(var(--neon-blue) / 0.3)",
          },
        },
        "float": {
          "0%, 100%": {
